...
// const std::array<Color, 10> kColors[3] = {
//     {0},
//     {0, 0, 1, 5},
//     {0, 0, 0, 1, 2, 3, 6, 1, 0, 1}};

// const Guess kGuesses[3] = {
//     {.code = (Code *)kColors[0][0], .feedback = (Feedback *)kFeedbackStates[0][0]},
//     {.code = (Code *)kColors[1][0], .feedback = (Feedback *)kFeedbackStates[1][0]},
//     {.code = (Code *)kColors[2][0], .feedback = (Feedback *)kFeedbackStates[2][0]}};
...
// {
//     size_t input_values[3] = {1, 5, 10};
//     size_t color_size = sizeof(Color);
...
//         size_t expected_value = input_value * color_size;
